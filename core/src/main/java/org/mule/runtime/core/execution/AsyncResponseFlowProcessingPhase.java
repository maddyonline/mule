...
public class AsyncResponseFlowProcessingPhase
  ...
  private Function<Throwable, Publisher<? extends MuleEvent>> handleExceptions(MessageSource messageSource,
                                                                               AsyncResponseFlowProcessingPhaseTemplate template,
  ...
  private Consumer<MuleEvent> sendResponseToClient(MessagingExceptionHandler exceptionHandler,
                                                   AsyncResponseFlowProcessingPhaseTemplate template,
                                                   PhaseResultNotifier phaseResultNotifier) {
    return event -> {
      try {
